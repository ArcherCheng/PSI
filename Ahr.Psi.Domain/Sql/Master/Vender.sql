...
CREATE TABLE Vender(
	...
	VenderName nvarchar(60) NOT NULL,
...
CONSTRAINT PK_Vender PRIMARY KEY CLUSTERED (VenderId));
go


Create Trigger Vender_Tr1 On Vender After Insert,Update,Delete Not For Replication As
Begin
	Declare @TableName Nvarchar(30);
	Set @TableName='Vender';
